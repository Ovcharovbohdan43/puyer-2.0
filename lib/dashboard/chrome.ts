...
export const dash = {
  ...
  sidebar: "dash-sidebar fixed top-0 left-0 z-30 hidden h-dvh w-[260px] max-w-[260px] flex-col overflow-hidden border-r border-[#E5E7EB] p-4 lg:flex",
  btnSecondary:
  ...
  dataTable: "w-max min-w-full table-auto text-left",
